var data = document.querySelector("#graphic");
...
document.querySelector("#filterForm").addEventListener("submit", function (e) {
    e.preventDefault();
    var graphicType = document.querySelector("#graphicType").value;
    chart.config.type = graphicType;
    var graphicData = document.querySelector("#graphicData").value;
...
document.querySelector("#filterCredit").addEventListener("submit", function (e) {
    e.preventDefault();
    var minValue = parseInt(document.querySelector("#filterCreditInput").value, 10);
    if (minValue > 1000) {
...
document.querySelector("#filterDebit").addEventListener("submit", function (e) {
    e.preventDefault();
    var minValue = parseInt(document.querySelector("#filterDebitInput").value, 10);
    if (minValue > 1000) {
